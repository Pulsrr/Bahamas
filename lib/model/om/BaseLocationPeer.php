...
abstract class BaseLocationPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Adress', 'Count', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'adress', 'count', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ADRESS, self::COUNT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'adress', 'count', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Adress' => 1, 'Count' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'adress' => 1, 'count' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ADRESS => 1, self::COUNT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'adress' => 1, 'count' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocationPeer::ADRESS);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLocationPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLocationPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLocationPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLocationPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLocationPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLocationPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseLocationPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseLocationPeer', $values, $con, $ret);
    }
