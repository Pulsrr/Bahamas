...
/**
 * Base class that represents a row from the 'participation' table.
 *
 * 
 *
...
abstract class BaseParticipation extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ParticipationPeer::ID;
		}
	...
	public function setDriverId($v)
	{
		...
		if ($this->driver_id !== $v) {
			$this->driver_id = $v;
			$this->modifiedColumns[] = ParticipationPeer::DRIVER_ID;
		}
	...
	public function setFareId($v)
	{
		...
		if ($this->fare_id !== $v) {
			$this->fare_id = $v;
			$this->modifiedColumns[] = ParticipationPeer::FARE_ID;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v) {
			$this->amount = $v;
			$this->modifiedColumns[] = ParticipationPeer::AMOUNT;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ParticipationPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = ParticipationPeer::NUM_COLUMNS - ParticipationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(ParticipationPeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ParticipationPeer::ID)) $criteria->add(ParticipationPeer::ID, $this->id);
		if ($this->isColumnModified(ParticipationPeer::DRIVER_ID)) $criteria->add(ParticipationPeer::DRIVER_ID, $this->driver_id);
		if ($this->isColumnModified(ParticipationPeer::FARE_ID)) $criteria->add(ParticipationPeer::FARE_ID, $this->fare_id);
		if ($this->isColumnModified(ParticipationPeer::AMOUNT)) $criteria->add(ParticipationPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(ParticipationPeer::CREATED_AT)) $criteria->add(ParticipationPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ParticipationPeer::ID, $this->id);
	...
	public function getDriver(PropelPDO $con = null)
	{
		if ($this->aDriver === null && ($this->driver_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aDriver->addParticipations($this);
			 */
		}
		return $this->aDriver;
	}
	...
	public function getFare(PropelPDO $con = null)
	{
		if ($this->aFare === null && ($this->fare_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aFare->addParticipations($this);
			 */
		}
		return $this->aFare;
	}
