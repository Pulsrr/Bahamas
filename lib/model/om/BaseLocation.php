...
abstract class BaseLocation extends BaseObject  implements Persistent {
	...
	public function setAdress($v)
	{
		...
		if ($this->adress !== $v) {
			$this->adress = $v;
			$this->modifiedColumns[] = LocationPeer::ADRESS;
		}
	...
	public function setCount($v)
	{
		...
		if ($this->count !== $v || $this->isNew()) {
			$this->count = $v;
			$this->modifiedColumns[] = LocationPeer::COUNT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = LocationPeer::NUM_COLUMNS - LocationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LocationPeer::ADRESS)) $criteria->add(LocationPeer::ADRESS, $this->adress);
		if ($this->isColumnModified(LocationPeer::COUNT)) $criteria->add(LocationPeer::COUNT, $this->count);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseLocation:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseLocation::%s', $method));
	  }
