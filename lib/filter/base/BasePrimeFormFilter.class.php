...
/**
 * Prime filter form base class.
 *
 * @package    bahamas
 * @subpackage filter
 * @author     Your name here
 */
abstract class BasePrimeFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'driver_id'  => new sfWidgetFormPropelChoice(array('model' => 'Driver', 'add_empty' => true)),
      'payer_id'   => new sfWidgetFormPropelChoice(array('model' => 'Driver', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'payer_id'   => new sfValidatorPropelChoice(array('required' => false, 'model' => 'Driver', 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('prime_filters[%s]');
