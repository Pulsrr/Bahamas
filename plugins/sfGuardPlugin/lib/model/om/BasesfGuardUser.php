...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Driver[] Collection to store aggregation of Driver objects.
	 */
	protected $collDrivers;

	/**
	 * @var        Criteria The criteria used to select the current contents of collDrivers.
	 */
	...
	/**
	 * Clears out the collDrivers collection (array).
	 *
	...
	/**
	 * Initializes the collDrivers collection (array).
	 *
	 ...
	 * related Drivers from storage. If this sfGuardUser is new, it will return
		...
		if ($this->collDrivers === null) {
			if ($this->isNew()) {
			   $this->collDrivers = array();
				...
				$criteria->add(DriverPeer::USER_ID, $this->id);
	...
	public function countDrivers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collDrivers === null) {
			if ($this->isNew()) {
				...
				$count = DriverPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addDriver(Driver $l)
	{
		...
		if (!in_array($l, $this->collDrivers, true)) { // only add it if the **same** object is not already associated
			array_push($this->collDrivers, $l);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related DriverCustomers from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collDriverCustomers === null) {
			if ($this->isNew()) {
			   $this->collDriverCustomers = array();
				...
				$criteria->add(DriverCustomerPeer::USER_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related UserUnavailabilitys from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUserUnavailabilitys === null) {
			if ($this->isNew()) {
			   $this->collUserUnavailabilitys = array();
				...
				$criteria->add(UserUnavailabilityPeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getUserUnavailabilitysJoinFare($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserUnavailabilitys === null) {
			if ($this->isNew()) {
				...
				$this->collUserUnavailabilitys = UserUnavailabilityPeer::doSelectJoinFare($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
