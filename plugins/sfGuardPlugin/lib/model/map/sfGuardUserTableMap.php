...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Driver', 'Driver', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
    $this->addRelation('DriverCustomer', 'DriverCustomer', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
    $this->addRelation('UserUnavailability', 'UserUnavailability', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
